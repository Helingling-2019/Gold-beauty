        ...
        v = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    s,
                    o;
                    r.controlNavScaffold = e('<div class="hd"><ul class="' + i + "control-nav " + i + t + '"></ul>');
        ...
        r.setup = function(t) {
            if (!p) {
                ...
                t === "init" && (o ? r.slides.css({
                    opacity: 0,
                    display: "block",
                    webkitTransition: "opacity " + r.vars.animationSpeed / 300 + "s ease",
                    zIndex: 1
        ...
        v = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    s,
                    o;
                    r.controlNavScaffold = e('<div class="hd"><ul class="' + i + "control-nav " + i + t + '"></ul></div>');
                    if (r.pagingCount > 1) for (var f = 0; f < r.pagingCount; f++) {
                        o = r.slides.eq(f);
                        ...
                        r.controlNavScaffold.find("ul").append("<li>" + s + "</li>");
                        n++
                    }
                    r.controlsContainer ? e(r.controlsContainer).append(r.controlNavScaffold) : r.append(r.controlNavScaffold);
                    v.controlNav.set();
